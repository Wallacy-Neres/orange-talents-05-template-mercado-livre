...
import br.com.zup.mercadolivre.controller.dto.DetalheProdutoResponseDTO;
...
public class ProdutoController {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<DetalheProdutoResponseDTO> buscaProduto(@PathVariable("id") Long id) {
		Produto produtoSeleciona = manager.find(Produto.class, id);
		return ResponseEntity.ok(new DetalheProdutoResponseDTO(produtoSeleciona));
	}
}
